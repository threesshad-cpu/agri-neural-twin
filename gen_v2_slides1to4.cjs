...
function glowLine(sl,x,y,w,col) {
  ...
  sl.addShape(prs.ShapeType.rect,{x,y:y+0.03,w,h:0.01,fill:{color:col+"80"}});
}
...
// ══ SLIDE 3: SOLUTION ══
{
  ...
  layers.forEach((l,i)=>{
    ...
    sl.addShape(prs.ShapeType.rect,{x:0.3,y,w:12.7,h:0.42,fill:{color:l.col+"22"}});
...
// ══ SLIDE 4: ARCHITECTURE DIAGRAM ══
{
  ...
  [fe,be,ex].forEach((list,ci)=>{
    ...
    list.forEach((item,i)=>{
      sl.addShape(prs.ShapeType.rect,{x,y:1.42+i*0.59,w:4.1,h:0.5,fill:{color:bg},line:{color:col+"88",width:0.75},shadow:sh()});
