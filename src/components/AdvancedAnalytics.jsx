...
const trendData = [
    ...
    { year: '2025 (P)', yield: 4100, price: 2900, rainfall: 700, predicted: true },
    { year: '2026 (P)', yield: 3900, price: 3400, rainfall: 650, predicted: true },
    { year: '2027 (P)', yield: 4300, price: 2600, rainfall: 800, predicted: true },
    { year: '2028 (P)', yield: 4800, price: 2100, rainfall: 920, predicted: true },
];
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem' }}>
                    {['Q1 2026', 'Q2 2026', 'Q3 2026', 'Q4 2026'].map((q, i) => (
                        <div key={q} style={{ background: 'var(--grey-50)', padding: '1rem', border: '1px solid var(--color-border)', borderRadius: '4px', textAlign: 'center' }}>
                            <div style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)', fontWeight: '500' }}>{q}</div>
