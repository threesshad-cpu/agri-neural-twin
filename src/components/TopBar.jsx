...
export default function TopBar({ selectedDistrict, onDistrictChange, districts, loading, viewMode, setViewMode, onLogout }) {
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', background: 'var(--grey-100)', padding: '4px', borderRadius: '6px' }}>
                    <button
                        ...
                        className={viewMode === 'dashboard' ? 'topbar-tab active' : 'topbar-tab'}
                        style={{
                            padding: '4px 12px', border: 'none', background: viewMode === 'dashboard' ? 'white' : 'transparent',
                            borderRadius: '4px', boxShadow: viewMode === 'dashboard' ? '0 1px 2px rgba(0,0,0,0.1)' : 'none',
                            color: viewMode === 'dashboard' ? 'var(--gov-blue-600)' : 'var(--color-text-secondary)', fontWeight: '600', cursor: 'pointer'
                        }}
                    >
                        {t('dashboard')}
                    </button>
                    <button
                        ...
                        className={viewMode === 'analytics' ? 'topbar-tab active' : 'topbar-tab'}
                        style={{
                            padding: '4px 12px', border: 'none', background: viewMode === 'analytics' ? 'white' : 'transparent',
                            borderRadius: '4px', boxShadow: viewMode === 'analytics' ? '0 1px 2px rgba(0,0,0,0.1)' : 'none',
                            color: viewMode === 'analytics' ? 'var(--gov-blue-600)' : 'var(--color-text-secondary)', fontWeight: '600', cursor: 'pointer'
                        }}
                    >
