...
{t('settings_cfg.light')}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <option value="ta">{t('auto.tamil', 'தமிழ் (Tamil)')}</option>
                            <option value="te">{t('auto.telugu', 'తెలుగు (Telugu)')}</option>
                            <option value="kn">{t('auto.kannada', 'ಕನ್ನಡ (Kannada)')}</option>
                            <option value="ml">{t('auto.malayalam', 'മലയാളം (Malayalam)')}</option>
                            <option value="ur">{t('auto.urdu', 'اردو (Urdu)')}</option>
                        </select>
                    </div>
                </div>
